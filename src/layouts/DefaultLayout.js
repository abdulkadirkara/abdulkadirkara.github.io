...
import Footer from "../components/multibleComp/footer/Footer";
...
const DefaultLayout = ({ children }) => {
  ...
  return (
    <Root>
      ...
      <GlobalStyle />
      <Drawer>
        <BoxComp sx={{ display: { xs: "block", md: "none" } }}>
          <Sidebar
      ...
      <AppContent>
        ...
        <Footer rightTextVisible={windowWidth > 600 ? true : false} />
      </AppContent>
    </Root>
  );
};
